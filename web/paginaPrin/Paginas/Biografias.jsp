...
<html style="height: 100%; width: 100%; margin: 0px">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Carrois+Gothic+SC|Nanum+Gothic" rel="stylesheet">
    ...
    <body style="height: 100%; width: 100%; margin: 0px" >
        ...
        <div id='inicio' style='top:8%; height: 92%;  ' class='div2'><image style="position: absolute; width: 100%; height: 100%" src="../imagenes/fondd.jpg"></div>
            ...
            try {
                ...
                while (result.next()) {
                    ...
                    if (tipo == 1) {
                        ...
                        out.println("document.getElementById('ind').innerHTML+=\"<span name='" + (contai) + "' id='" + (contai) + "' onclick='bioind(" + (contai) + ")' class='spInd spt' ><img src='" + Imagen + "' alt='?' id='ima" + contai + "' style='width: 100%; height: 70%; border-radius: 15px 15px 15px 15px; '> <br> <p style='color: white; text-align: center;'>" + Titulo + "</p></span>\"");
                    ...
                    if (tipo == 2) {
                        ...
                        out.println("document.getElementById('ref').innerHTML+=\"<span name='" + (contaf) + "' id='" + (contaf) + "' onclick='bioref(" + (contaf) + ")' class='spRef spt'><img src='" + Imagen + "' alt='?' id='ima" + contaf + "' style='width: 100%; height: 70%; border-radius: 15px 15px 15px 15px; '> <br> <p style='color: white; text-align: center;'>" + Titulo + "</p></span>\"");
                    ...
                    if (tipo == 3) {
                        ...
                        out.println("document.getElementById('rev').innerHTML+=\"<span name='" + (contav) + "' id='" + (contav) + "' onclick='biorev(" + (contav) + ")' class='spRev spt'><img src='" + Imagen + "' alt='?' id='ima" + contav + "' style='width: 100%; height: 70%; border-radius: 15px 15px 15px 15px; '> <br> <p style='color: white; text-align: center;'>" + Titulo + "</p></span>\"");
        ...
        <form name="guardarBio" id="guardarBio" method="post" action="guardarBiografia.jsp">
            <div style="position: absolute; top: 8%; left:40%">
                <p  id="titulo" style="text-align: center; margin-top: 0; color: green; font-size: 40px; margin-bottom: 5px; font-family: 'Nanum Gothic', sans-serif;"></p>
            </div>
            <div class="div3">
