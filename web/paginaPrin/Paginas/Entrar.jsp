            ...
            try{
                ...
                while(resultProf.next()){
                    ...
                    if(correo.equals(cor) && con.equals(contra)){
                        ...
                        out.println("<script>location.replace('/MexicoInTempore/paginaPrin/Paginas/Seleccion.html');</script>");
                ...
                while(result.next()){
                    ...
                    if(correo.equals(cor) && con.equals(contra)){
                        ...
                        out.println("<script>location.href = '/MexicoInTempore/paginaPrin/Paginas/Seleccion.html';</script>");
                ...
                out.println("<script>location.href='/MexicoInTempore/paginaPrin/Paginas/Inicio.html';</script>");
